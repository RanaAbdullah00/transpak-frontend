...
export function deriveShipmentUIState(snapshot = {}) {
  ...
  return {
    ...
    showCarrierAdvance: canUpdateStatus && isCarrier && status !== 'delivered' && status !== 'closed',
    canUpdateStatus: canUpdateStatus && isCarrier && status !== 'delivered' && status !== 'closed',
    showShipperClose: isShipper && status === 'delivered',
